...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        OutputContententalness();
    }

    void OutputContententalness()
    {
        ...
        float xCoorda = (float)(x / 16f) * scale;
        float xCoordb = (float)((x + 1000) / 16f) * (scale * 2);
        float xCoordc = (float)((x + 2000) / 16f) * (scale * 4);
        float zCoorda = (float)((z) / 16f) * scale;
        float zCoordb = (float)((z + 1000) / 16f) * (scale * 2);
        float zCoordc = (float)((z + 2000) / 16f) * (scale * 4);
      ...
      //  Debug.Log("x = " + x + ", z = " + z + ", c = " + contientalness);
    }
